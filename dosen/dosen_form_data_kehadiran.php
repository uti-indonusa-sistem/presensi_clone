...
<table class="table table-striped table-bordered table-hover" id="dataTables-example">
	...
	<td>";
		...
		<a href='" . $base_url . "/cetak/kehadiran_pdf.php?id_kelas=" . str_replace("-", "_yz_", $dataMataKuliah['xid_kls']) . "&id_ptk=" . str_replace("-", "_yz_", $id_ptk_cookie) . "' target='_blank'><img src='medicio/PDF-icon.png' width='20px'></a>
		</td>
		</tr>";
			}
	...
	<a href='" . $base_url . "/cetak/jurnal_pdf.php?id_kelas=" . str_replace("-", "_yz_", $dataGabungan['xid_kls']) . "&id_ptk=" . str_replace("-", "_yz_", $id_ptk_cookie) . "' target='_blank'><img src='medicio/PDF-icon.png' width='20px'></a>
	</td>
	</tr>";
			$no++;
	...
	viewKelasKuliah.id_ptk='" . $_COOKIE['simpreskul_id_ptk'] . "' AND viewKelasKuliah.id_smt='" . $id_smt_post . "'");
		...
		<a href='" . $base_url . "/cetak/kehadiran_pdf.php?id_kelas=" . str_replace("-", "_yz_", $dataBukanKelasGabungan['xid_kls']) . "&id_ptk=" . str_replace("-", "_yz_", $_COOKIE['simpreskul_id_ptk']) . "' target='_blank'><img src='medicio/PDF-icon.png' width='20px'></a>
		</td>
		...
		<td>
			...
			<a href='" . $base_url . "/cetak/jurnal_pdf.php?id_kelas=" . str_replace("-", "_yz_", $dataBukanKelasGabungan['xid_kls']) . "&id_ptk=" . str_replace("-", "_yz_", $_COOKIE['simpreskul_id_ptk']) . "' target='_blank'><img src='medicio/PDF-icon.png' width='20px'></a>
			</td>
		</tr>";
			$no++;
		}
