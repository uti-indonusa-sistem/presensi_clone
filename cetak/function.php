...
function view_kelas($id_kls,$kolom){
	...
	if ($kolom=='nm_matkul'){
		...
		$prodi=$dataProdi[0];
		if ($prodi=='A'){$prodi="Teknologi Otomotif";}
		else if ($prodi=='B'){$prodi="Sistem Informasi";}
...
function cek_gabungan($id_kelas){
	...
	$kondisiId_kls="";
	$y=1;
	if(!$dataKelasGabungan) return "presensi_jurnal_perkuliahan.xid_kls=".str_replace("_yz_","-",$id_kelas);
...
function konversi_bulan($bulan){
	...
	else if ($bulan=='02'){ return "Februari";}
	else if ($bulan=='03'){ return "Maret";}
	else if ($bulan=='04'){ return "April";}
	else if ($bulan=='05'){ return "Mei";}
	else if ($bulan=='06'){ return "Juni";}
	else if ($bulan=='07'){ return "Juli";}
	else if ($bulan=='08'){ return "Agustus";}
	else if ($bulan=='09'){ return "September";}
	else if ($bulan=='10'){ return "Oktober";}
	else if ($bulan=='11'){ return "Nopember";}
...
function konversi_prodi_singkatan($prodi){
	if ($prodi=='A'){$prodi="MO";}
	else if ($prodi=='B'){$prodi="MI";}
	else if ($prodi=='C'){$prodi="KM";}
	else if ($prodi=='D'){$prodi="HT";}
	else if ($prodi=='E'){$prodi="Far";}
	else if ($prodi=='F'){$prodi="MIK";}
