...
presensi_kelas_gabungan.id_gabungan");
		...
		");
			...
			<a href='" . $base_url . "/cetak/kehadiran_pdf.php?id_kelas=" . str_replace("-", "_yz_", $dataMataKuliah['xid_kls']) . "&id_ptk=" . str_replace("-", "_yz_", $dataMataKuliah['id_ptk']) . "' target='_blank'><img src='medicio/PDF-icon.png' width='20px'></a>
		...
		<a href='" . $base_url . "/cetak/jurnal_pdf.php?id_kelas=" . str_replace("-", "_yz_", $dataGabungan['xid_kls']) . "&id_ptk=" . str_replace("-", "_yz_", $dataGabungan['id_ptk']) . "' target='_blank'><img src='medicio/PDF-icon.png' width='20px'></a>
		</td>
		</tr>";
			$no++;
	...
	WHERE presensi_kelas_gabungan.xid_kls IS NULL AND viewKelasKuliah.xid_sms='" . $_POST['prodi'] . "' AND viewKelasKuliah.id_smt='" . $_POST['tahun_akademik'] . "'");
		...
		<a href='" . $base_url . "/cetak/kehadiran_pdf.php?id_kelas=" . str_replace("-", "_yz_", $dataBukanKelasGabungan['xid_kls']) . "&id_ptk=" . str_replace("-", "_yz_", $dataBukanKelasGabungan['id_ptk']) . "' target='_blank'><img src='medicio/PDF-icon.png' width='20px'></a>
		</td>
		...
		<td>
			...
			<a href='" . $base_url . "/cetak/jurnal_pdf.php?id_kelas=" . str_replace("-", "_yz_", $dataBukanKelasGabungan['xid_kls']) . "&id_ptk=" . str_replace("-", "_yz_", $dataBukanKelasGabungan['id_ptk']) . "' target='_blank'><img src='medicio/PDF-icon.png' width='20px'></a>
			</td>
		</tr>";
			$no++;
		}
