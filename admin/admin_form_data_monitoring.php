...
<div style="float:left; width:100%;" >
		...
		<tr>
			<td  style="width:12%;"><font style="font-size:10pt;"><font style="font-size:10pt;"><b>Periode</b></td>
			<td>
				<input type="date" name="awal" class="form-control" style="width:200px;margin-bottom:10px" required></input>
