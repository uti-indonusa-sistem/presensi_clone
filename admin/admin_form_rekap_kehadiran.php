...
<div style="float:left; width:100%;">
	<form action="<?php echo $base_url; ?>/cetak_rekap_kehadiran.html" method="POST" target="_blank">
		<table class="table table-striped table-bordered table-hover" id="dataTables-example" style="width:100%;">
			<tr>
				...
				<td style="width:12%;">
					<font style="font-size:10pt;">
						<font style="font-size:10pt;"><b>Tanggal</b>
				</td>
				<td style="width:25%;">
					<input name="tanggalAwal" type="date" class="form-control" style="width:150px;" required> sampai
					dengan
